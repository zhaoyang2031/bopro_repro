#!/bin/bash
# Saturn 30 seeds on GPU1: mpo2obj + mpo3obj + mpo4obj (seed 0-9)
...
echo "GPU1: Saturn 30 seeds (mpo2obj + mpo3obj + mpo4obj, seed 0-9)"
echo "Start: $(date)"
...
echo "[$(date)] GPU1: All 30 Saturn seeds done"
