    ...
    if requires_bo:
        add_kwargs = {
            ...
            **{k: v for k, v in {"matern_nu": args.kernel_matern_nu,
                                 ...
                                 "bnn_hidden_dim": args.bnn_hidden_dim}.items() if v is not None}
        }
    ...
    for t in pbar:
        ...
        for _i in range(opt_batch_size):
            ...
            for _target_tuple in target_cand_score_bbox_idx:
                ...
                print_targets.append((_target_tuple_rank, f"Rank of target: {_target_tuple_rank} (similarity={round(_target_tuple[1], 6)})"))
